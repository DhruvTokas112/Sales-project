...
*Top Performers and Revenue: Identified top-performing sales representatives, calculated total sales by each employee, and analyzed revenue generated by each category, state, and supplier.
*Customer and Product Insights: Explored customer distribution across states, average product quantities sold, and the subcategory with the highest average unit price.
